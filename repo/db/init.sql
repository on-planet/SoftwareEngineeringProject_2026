...
CREATE INDEX IF NOT EXISTS idx_stock_strategy_runs_code_updated ON stock_strategy_runs(strategy_code, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_stock_strategy_scores_symbol_asof ON stock_strategy_scores(symbol, as_of DESC);
CREATE INDEX IF NOT EXISTS idx_stock_strategy_scores_run_rank ON stock_strategy_scores(run_id, rank);
